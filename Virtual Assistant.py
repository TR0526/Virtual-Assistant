...
def taskexecution():    
    speak("Face verfication Successful")
    speak("Welcome thilakraj")
    pyautogui.press('esc')             
    wish()
    while True:
...
################################################################################################################################            
            ...
            if "send a mail" in query or "sent a mail" in query:
                email = 'sample@gmail.com' #enter gmail
                password = '12345' #enter the pass word
                send_to_email ='sample@gmailcom' #enter the receiver mail id here
